...
const technology=[
  ...
  ['424-2494-img-svg2.svg','Digital Design','Restorations designed by senior technicians in Exocad with full version control.'],
...
const workflow=[
  ...
  ['424-2716-img-svg1.svg','Design','A senior designer drafts the restoration in Exocad. You receive a 3D preview.'],
...
const benefits=[
  ...
  ['424-2862-img-svg2.svg','Clinician Support','Talk to the technician on your case directly. Real case planning, not order taking.'],
  ['424-2862-img-svg3.svg','Fast Turnaround','Average on single units, with rush available across the GCC.']
];
const gallery=[
  ['424-2969-img-full-arch-zirconia-restoration.png','Implant Solutions','Crown (E - MAX - ZIRCONIA)'],
  ['424-2969-img-implant-supported-bridge.png','Fixed Prosthetics','E-Max - Zirconia'],
  ['424-2969-img-veneer-smile-design.png','Aesthetic & Cosmetic','Veneer Smile Design'],
  ['424-2969-img-layered-ceramic-crowns.png','Digital Dentistry','Layered Ceramic Crowns']
];
const testimonials=[
