...
const workflow=[
  ...
  ['424-2716-img-svg1.svg','Design','A senior designer drafts the restoration in software.'],
...
const testimonials=[
  ...
  ['Al Najah Dental Lab has become a trusted extension of our clinic, delivering precise work, thoughtful support, and remarkable consistency.','Dr. Lina','The Dental Studio · Manama, Bahrain','L']
];
...
export function renderHomepage(){return `
  <div class="home-page">
    <section class="hp-hero" aria-label="The Silent Art Behind Every Confident Smile">
      ...
      <div class="hp-hero-shade"></div><div class="hp-hero-copy"><p class="hp-hero-intro">Al Najah Dental Lab..</p><h1>The Silent Art Behind<br>Every Confident Smile</h1><a class="hp-pill dark" href="#start">Start a Case <span>${arrow}</span></a></div>
    ...
    <section class="hp-foundation hp-rounded" id="foundation"><div class="hp-foundation-copy"><p class="hp-kicker">Our Purpose</p><h2>Built on Craft.<br><i>Driven by Care.</i></h2><p>At Al Najah Dental Lab, our technicians bring together skilled craftsmanship, advanced technology, and an eye for natural aesthetics. Working closely with clinicians, we refine every detail to create restorations that reflect the patient's individuality and the dentist's vision.</p><a class="hp-pill dark" href="about.html">About Our Lab <span>${arrow}</span></a></div><div class="hp-foundation-cards"><article><span>1&nbsp;&nbsp; Our Vision</span><h3>To Be the Region's Trusted Reference</h3><p>To become the region's most trusted premium dental laboratory reference, recognized for precision, natural aesthetics, and unwavering reliability.</p><p>We envision a future where dentists rely on Al Najah Dental Lab as their preferred laboratory partner for complex and aesthetic cases, confident that every result will meet the highest standards of quality and authenticity.</p><p>Our vision is to elevate laboratory craftsmanship and set a benchmark for excellence that inspires clinicians and advances patient care across the region.</p></article><article><span>2&nbsp;&nbsp; Our Mission</span><h3>Crafting Precision. Supporting Clinicians.</h3><p>To support clinicians in delivering exceptional dentistry through precision-crafted dental solutions that combine advanced technology, aesthetic sensitivity, and disciplined craftsmanship.</p><p>We work as an extension of the dentist, refining every detail until each restoration feels natural, accurate, and worthy of the patient who will wear it.</p><p>Through innovation, continuous education, and unwavering dedication, we transform laboratory work into a trusted partnership that enhances clinical outcomes and professional confidence.</p></article></div></section>

    <section class="hp-technology hp-band"><div class="hp-two-head"><div><p class="hp-kicker">Digital Dentistry</p><h2>Technology that earns<br><i>clinical confidence.</i></h2></div><div><p>Every restoration runs through a fully digital pipeline of scanning, design, milling, and printing, operated by technicians who treat the software as a tool, not a shortcut.</p><a href="technology.html">Explore our technology <span>${arrow}</span></a></div></div><div class="hp-tech-grid">${technology.map(([ic,h,p])=>`<article><span class="hp-icon">${fig(ic)}</span><h3>${h}</h3><p>${p}</p></article>`).join('')}</div></section>
